...
int main()
{
    ...
    {
    cout<<caso1(deltax, pas[i], pres[i], fut[i], condicion, A0,L)<<endl;
    cout<<caso2(deltax, pas[i], pres[i], fut[i], condicion, A0,L)<<endl;
    cout<<caso3(deltax, pas[i], pres[i], fut[i], condicion, A0,L)<<endl;
    }
...
double caso3(double deltax, double pas[], double pres[], double fut[], double condicion, double A0, double L, double c, double PI)
{
    ofstream outfile;
    for (int i=0;i<deltax;i++)  ///Condiciones iniciales caso 1
    {
